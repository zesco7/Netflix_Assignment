...
class FirstView: BaseView {
    ...
    override func setConstraints() {
        ...
        tvButton.snp.makeConstraints { make in
            ...
            make.trailing.equalTo(movieButton.snp.leading).offset(-20)
            make.width.greaterThanOrEqualTo(50)
        ...
        movieButton.snp.makeConstraints { make in
            make.top.equalTo(self.safeAreaLayoutGuide).offset(30)
            make.trailing.equalTo(contentsButton.snp.leading).offset(-20)
            make.width.greaterThanOrEqualTo(50)
            make.height.equalTo(20)
        }
        ...
        contentsButton.snp.makeConstraints { make in
            make.top.equalTo(self.safeAreaLayoutGuide).offset(30)
            make.trailing.equalTo(backgroundImage.snp.trailing).offset(-20)
            make.width.greaterThanOrEqualTo(50)
            make.height.equalTo(20)
        }
        ...
        contentsButtonWithImage.snp.makeConstraints { make in
            ...
            make.trailing.equalTo(playButtonWithImage.snp.leading).offset(-40)
        }
        ...
        previewImage.snp.makeConstraints { make in
            ...
            make.trailing.equalTo(previewImage2.snp.leading).offset(-30)
        ...
        previewImage3.snp.makeConstraints { make in
            make.top.equalTo(previewLabel.snp.bottom).offset(10)
            make.leading.equalTo(previewImage2.snp.trailing).offset(30)
            make.size.equalTo(100)
        }
    }
}
